...
type Transaccion struct {
	...
	CarteraClienteID *uint     `gorm:"column:cartera_cliente_id;index" json:"cartera_cliente_id,omitempty"`
	CarteraAbonoID   *uint     `gorm:"column:cartera_abono_id;index" json:"cartera_abono_id,omitempty"`
}
...
type TransaccionCreateInput struct {
	...
	CarteraClienteID *uint   `json:"cartera_cliente_id,omitempty"`
}
